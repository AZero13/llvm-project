...
; CHECK-GI-NEXT:    sshll2.8h v3, v0, #0
; CHECK-GI-NEXT:    sshll.8h v4, v1, #0
; CHECK-GI-NEXT:    sshll2.8h v5, v1, #0
; CHECK-GI-NEXT:    ssubl.8h v6, v1, v0
; CHECK-GI-NEXT:    ssubl2.8h v7, v1, v0
; CHECK-GI-NEXT:    ssubl.8h v16, v0, v1
; CHECK-GI-NEXT:    ssubl2.8h v1, v0, v1
; CHECK-GI-NEXT:    cmgt.8h v0, v4, v2
; CHECK-GI-NEXT:    cmgt.8h v2, v5, v3
; CHECK-GI-NEXT:    bsl.16b v0, v6, v16
; CHECK-GI-NEXT:    bit.16b v1, v7, v2
; CHECK-GI-NEXT:    ret
...
; CHECK-GI-NEXT:    ushll2.8h v3, v0, #0
; CHECK-GI-NEXT:    ushll.8h v4, v1, #0
; CHECK-GI-NEXT:    ushll2.8h v5, v1, #0
; CHECK-GI-NEXT:    usubl.8h v6, v1, v0
; CHECK-GI-NEXT:    usubl2.8h v7, v1, v0
; CHECK-GI-NEXT:    usubl.8h v16, v0, v1
; CHECK-GI-NEXT:    usubl2.8h v1, v0, v1
; CHECK-GI-NEXT:    cmhi.8h v0, v4, v2
; CHECK-GI-NEXT:    cmhi.8h v2, v5, v3
; CHECK-GI-NEXT:    bsl.16b v0, v6, v16
; CHECK-GI-NEXT:    bit.16b v1, v7, v2
; CHECK-GI-NEXT:    ret
...
; CHECK-GI-NEXT:    ushll.8h v5, v0, #0
; CHECK-GI-NEXT:    ldr d1, [x8, :lo12:.LCPI106_0]
; CHECK-GI-NEXT:    adrp x8, .LCPI106_1
; CHECK-GI-NEXT:    ushll2.8h v6, v0, #0
; CHECK-GI-NEXT:    ldr d2, [x8, :lo12:.LCPI106_1]
; CHECK-GI-NEXT:    ushll.8h v4, v1, #0
; CHECK-GI-NEXT:    ushll.8h v7, v2, #0
; CHECK-GI-NEXT:    usubl.8h v16, v2, v0
; CHECK-GI-NEXT:    usubl.8h v2, v0, v2
; CHECK-GI-NEXT:    usubl.8h v1, v3, v1
; CHECK-GI-NEXT:    usubw2.8h v17, v4, v0
; CHECK-GI-NEXT:    cmhi.8h v3, v4, v6
; CHECK-GI-NEXT:    cmhi.8h v0, v7, v5
; CHECK-GI-NEXT:    bit.16b v1, v17, v3
; CHECK-GI-NEXT:    bsl.16b v0, v16, v2
; CHECK-GI-NEXT:    ret
  %aext = zext <16 x i8> %a to <16 x i16>
...
; CHECK-GI-NEXT:    mov d3, v0[1]
; CHECK-GI-NEXT:    sshll.8h v5, v0, #0
; CHECK-GI-NEXT:    ldr d1, [x8, :lo12:.LCPI107_0]
; CHECK-GI-NEXT:    adrp x8, .LCPI107_1
; CHECK-GI-NEXT:    sshll2.8h v6, v0, #0
; CHECK-GI-NEXT:    ldr d2, [x8, :lo12:.LCPI107_1]
; CHECK-GI-NEXT:    sshll.8h v4, v1, #0
; CHECK-GI-NEXT:    sshll.8h v7, v2, #0
; CHECK-GI-NEXT:    ssubl.8h v16, v2, v0
; CHECK-GI-NEXT:    ssubl.8h v2, v0, v2
; CHECK-GI-NEXT:    ssubl.8h v1, v3, v1
; CHECK-GI-NEXT:    ssubw2.8h v17, v4, v0
; CHECK-GI-NEXT:    cmgt.8h v3, v4, v6
; CHECK-GI-NEXT:    cmgt.8h v0, v7, v5
; CHECK-GI-NEXT:    bit.16b v1, v17, v3
; CHECK-GI-NEXT:    bsl.16b v0, v16, v2
; CHECK-GI-NEXT:    ret
  %aext = sext <16 x i8> %a to <16 x i16>
...
; CHECK-GI-NEXT:    sub.8h v6, v3, v0
; CHECK-GI-NEXT:    sub.8h v7, v4, v1
; CHECK-GI-NEXT:    cmgt.8h v0, v3, v0
; CHECK-GI-NEXT:    cmgt.8h v1, v4, v1
; CHECK-GI-NEXT:    bsl.16b v0, v6, v5
; CHECK-GI-NEXT:    bsl.16b v1, v7, v2
; CHECK-GI-NEXT:    ret
  %bext = sext <16 x i8> %b to <16 x i16>
  %abdiff = sub nsw <16 x i16> %aext, %bext
  %abcmp = icmp slt <16 x i16> %aext, %bext
...
; CHECK-GI-NEXT:    sub.8h v6, v3, v0
; CHECK-GI-NEXT:    sub.8h v7, v4, v1
; CHECK-GI-NEXT:    cmhi.8h v0, v3, v0
; CHECK-GI-NEXT:    cmhi.8h v1, v4, v1
; CHECK-GI-NEXT:    bsl.16b v0, v6, v5
; CHECK-GI-NEXT:    bsl.16b v1, v7, v2
; CHECK-GI-NEXT:    ret
  %bext = zext <16 x i8> %b to <16 x i16>
