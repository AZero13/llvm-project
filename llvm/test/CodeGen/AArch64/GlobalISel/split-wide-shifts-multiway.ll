...
; GISEL-NEXT:    cmp x9, #0
; GISEL-NEXT:    str x0, [sp, #120] ; 8-byte Folded Spill
; GISEL-NEXT:    str x5, [sp, #328] ; 8-byte Folded Spill
...
; GISEL-NEXT:    cmp x11, #0
; GISEL-NEXT:    str x8, [sp, #200] ; 8-byte Folded Spill
...
; GISEL-NEXT:    str x16, [sp, #272] ; 8-byte Folded Spill
...
; GISEL-NEXT:    cmp x11, #0
; GISEL-NEXT:    str x8, [sp, #176] ; 8-byte Folded Spill
...
; GISEL-NEXT:    cmp x11, #0
; GISEL-NEXT:    str x8, [sp, #168] ; 8-byte Folded Spill
...
; GISEL-NEXT:    csel x10, x12, x10, eq
; GISEL-NEXT:    cmp x11, #0
; GISEL-NEXT:    str x10, [sp, #152] ; 8-byte Folded Spill
...
; GISEL-NEXT:    str x17, [sp, #280] ; 8-byte Folded Spill
; GISEL-NEXT:    csel x10, x12, x10, eq
; GISEL-NEXT:    cmp x11, #0
; GISEL-NEXT:    str x6, [sp, #296] ; 8-byte Folded Spill
; GISEL-NEXT:    csel x12, xzr, x27, eq
; GISEL-NEXT:    cmp x9, #6
; GISEL-NEXT:    orr x12, x26, x12
; GISEL-NEXT:    csel x10, x12, x10, eq
...
; GISEL-NEXT:    cmp x11, #0
; GISEL-NEXT:    str x12, [sp, #144] ; 8-byte Folded Spill
...
; GISEL-NEXT:    str x20, [sp, #248] ; 8-byte Folded Spill
...
; GISEL-NEXT:    cmp x11, #0
; GISEL-NEXT:    str x10, [sp, #136] ; 8-byte Folded Spill
...
; GISEL-NEXT:    orr x12, x0, x12
; GISEL-NEXT:    str x16, [sp, #48] ; 8-byte Folded Spill
; GISEL-NEXT:    csel x10, x12, x10, eq
; GISEL-NEXT:    cmp x11, #0
; GISEL-NEXT:    csel x12, xzr, x15, eq
; GISEL-NEXT:    cmp x9, #6
; GISEL-NEXT:    ldr x15, [sp, #328] ; 8-byte Folded Reload
; GISEL-NEXT:    orr x12, x14, x12
; GISEL-NEXT:    csel x10, x12, x10, eq
; GISEL-NEXT:    cmp x11, #0
...
; GISEL-NEXT:    csel x10, x12, x10, eq
; GISEL-NEXT:    cmp x11, #0
; GISEL-NEXT:    str x28, [sp, #56] ; 8-byte Folded Spill
; GISEL-NEXT:    csel x12, xzr, x27, eq
; GISEL-NEXT:    cmp x9, #8
; GISEL-NEXT:    ldr x27, [sp, #208] ; 8-byte Folded Reload
; GISEL-NEXT:    orr x12, x26, x12
; GISEL-NEXT:    csel x10, x12, x10, eq
; GISEL-NEXT:    cmp x9, #9
; GISEL-NEXT:    csel x10, x22, x10, eq
...
; GISEL-NEXT:    cmp x11, #0
; GISEL-NEXT:    str x12, [sp, #128] ; 8-byte Folded Spill
; GISEL-NEXT:    mov x15, x6
; GISEL-NEXT:    lsl x0, x10, x11
; GISEL-NEXT:    csel x12, xzr, x8, eq
; GISEL-NEXT:    cmp x9, #0
; GISEL-NEXT:    str x8, [sp, #312] ; 8-byte Folded Spill
; GISEL-NEXT:    orr x12, x0, x12
...
; GISEL-NEXT:    str x21, [sp, #288] ; 8-byte Folded Spill
; GISEL-NEXT:    csel x12, x13, x12, eq
; GISEL-NEXT:    cmp x11, #0
; GISEL-NEXT:    stp x15, x30, [sp, #64] ; 16-byte Folded Spill
; GISEL-NEXT:    csel x13, xzr, x6, eq
; GISEL-NEXT:    cmp x9, #4
; GISEL-NEXT:    ldr x6, [sp, #296] ; 8-byte Folded Reload
...
; GISEL-NEXT:    csel x12, x22, x12, eq
; GISEL-NEXT:    cmp x9, #11
; GISEL-NEXT:    ldr x22, [sp, #280] ; 8-byte Folded Reload
; GISEL-NEXT:    csel x12, xzr, x12, eq
; GISEL-NEXT:    cmp x9, #12
...
; GISEL-NEXT:    csel x10, x10, x12, eq
; GISEL-NEXT:    cmp x11, #0
; GISEL-NEXT:    str x10, [sp, #112] ; 8-byte Folded Spill
...
; GISEL-NEXT:    csel x12, xzr, x8, eq
; GISEL-NEXT:    cmp x9, #1
; GISEL-NEXT:    ldr x8, [sp, #328] ; 8-byte Folded Reload
; GISEL-NEXT:    orr x12, x0, x12
...
; GISEL-NEXT:    str x15, [sp, #40] ; 8-byte Folded Spill
; GISEL-NEXT:    csel x10, x12, x10, eq
; GISEL-NEXT:    cmp x11, #0
; GISEL-NEXT:    csel x12, xzr, x7, eq
; GISEL-NEXT:    cmp x9, #6
...
; GISEL-NEXT:    cmp x9, #9
; GISEL-NEXT:    orr x12, x25, x12
; GISEL-NEXT:    ldr x25, [sp, #16] ; 8-byte Folded Reload
; GISEL-NEXT:    csel x10, x12, x10, eq
; GISEL-NEXT:    cmp x11, #0
; GISEL-NEXT:    csel x12, xzr, x25, eq
; GISEL-NEXT:    cmp x9, #10
...
; GISEL-NEXT:    str x12, [sp, #104] ; 8-byte Folded Spill
; GISEL-NEXT:    ldp x12, x1, [sp, #232] ; 16-byte Folded Reload
; GISEL-NEXT:    cmp x11, #0
; GISEL-NEXT:    lsl x16, x10, x11
; GISEL-NEXT:    str x14, [sp, #32] ; 8-byte Folded Spill
; GISEL-NEXT:    lsr x13, x24, x12
; GISEL-NEXT:    ldr x24, [sp, #312] ; 8-byte Folded Reload
; GISEL-NEXT:    str x16, [sp, #24] ; 8-byte Folded Spill
; GISEL-NEXT:    csel x8, xzr, x13, eq
; GISEL-NEXT:    cmp x9, #0
; GISEL-NEXT:    str x13, [sp, #304] ; 8-byte Folded Spill
; GISEL-NEXT:    orr x8, x16, x8
; GISEL-NEXT:    csel x8, x8, xzr, eq
; GISEL-NEXT:    cmp x11, #0
; GISEL-NEXT:    csel x13, xzr, x4, eq
; GISEL-NEXT:    cmp x9, #1
; GISEL-NEXT:    ldr x4, [sp, #248] ; 8-byte Folded Reload
...
; GISEL-NEXT:    cmp x9, #7
; GISEL-NEXT:    orr x13, x22, x13
; GISEL-NEXT:    ldr x22, [sp, #48] ; 8-byte Folded Reload
; GISEL-NEXT:    csel x8, x13, x8, eq
; GISEL-NEXT:    cmp x11, #0
; GISEL-NEXT:    csel x13, xzr, x3, eq
; GISEL-NEXT:    cmp x9, #8
...
; GISEL-NEXT:    csel x8, xzr, x8, eq
; GISEL-NEXT:    cmp x9, #14
; GISEL-NEXT:    str x13, [sp, #80] ; 8-byte Folded Spill
; GISEL-NEXT:    csel x8, xzr, x8, eq
; GISEL-NEXT:    cmp x9, #15
; GISEL-NEXT:    csel x8, xzr, x8, eq
; GISEL-NEXT:    cmp x28, #0
...
; GISEL-NEXT:    str x8, [sp, #96] ; 8-byte Folded Spill
; GISEL-NEXT:    csel x8, xzr, x13, eq
; GISEL-NEXT:    cmp x9, #0
; GISEL-NEXT:    orr x8, x10, x8
; GISEL-NEXT:    str x10, [sp, #320] ; 8-byte Folded Spill
; GISEL-NEXT:    ldr x13, [sp, #64] ; 8-byte Folded Reload
; GISEL-NEXT:    csel x8, x8, xzr, eq
; GISEL-NEXT:    cmp x11, #0
...
; GISEL-NEXT:    orr x10, x1, x10
; GISEL-NEXT:    ldr x1, [sp, #32] ; 8-byte Folded Reload
; GISEL-NEXT:    csel x8, x10, x8, eq
; GISEL-NEXT:    cmp x11, #0
; GISEL-NEXT:    csel x10, xzr, x4, eq
; GISEL-NEXT:    cmp x9, #4
...
; GISEL-NEXT:    ldr x17, [sp, #328] ; 8-byte Folded Reload
; GISEL-NEXT:    csel x8, x10, x8, eq
; GISEL-NEXT:    cmp x11, #0
...
; GISEL-NEXT:    cmp x9, #8
; GISEL-NEXT:    ldr x6, [sp, #72] ; 8-byte Folded Reload
...
; GISEL-NEXT:    ldr x20, [sp, #56] ; 8-byte Folded Reload
; GISEL-NEXT:    csel x8, x10, x8, eq
; GISEL-NEXT:    cmp x11, #0
; GISEL-NEXT:    csel x10, xzr, x3, eq
; GISEL-NEXT:    cmp x9, #11
; GISEL-NEXT:    orr x10, x21, x10
; GISEL-NEXT:    ldr x21, [sp, #232] ; 8-byte Folded Reload
; GISEL-NEXT:    csel x8, x10, x8, eq
; GISEL-NEXT:    cmp x11, #0
...
; GISEL-NEXT:    cmp x9, #0
; GISEL-NEXT:    str x10, [sp, #32] ; 8-byte Folded Spill
; GISEL-NEXT:    ldr x10, [sp, #320] ; 8-byte Folded Reload
; GISEL-NEXT:    str x27, [sp, #328] ; 8-byte Folded Spill
; GISEL-NEXT:    orr x1, x27, x1
; GISEL-NEXT:    ldr x27, [sp, #80] ; 8-byte Folded Reload
...
; GISEL-NEXT:    cmp x9, #2
; GISEL-NEXT:    ldr x2, [sp, #40] ; 8-byte Folded Reload
...
; GISEL-NEXT:    ldr x14, [sp, #224] ; 8-byte Folded Reload
; GISEL-NEXT:    csel x1, x30, x1, eq
; GISEL-NEXT:    cmp x11, #0
...
; GISEL-NEXT:    ldr x13, [sp, #208] ; 8-byte Folded Reload
; GISEL-NEXT:    cmp x9, #8
...
; GISEL-NEXT:    ldr x1, [sp, #328] ; 8-byte Folded Reload
; GISEL-NEXT:    csel x8, x8, xzr, eq
; GISEL-NEXT:    cmp x11, #0
; GISEL-NEXT:    csel x10, xzr, x10, eq
; GISEL-NEXT:    cmp x9, #1
...
; GISEL-NEXT:    cmp x9, #2
; GISEL-NEXT:    orr x10, x1, x10
; GISEL-NEXT:    ldr x1, [sp, #24] ; 8-byte Folded Reload
; GISEL-NEXT:    csel x8, x10, x8, eq
...
; GISEL-NEXT:    csel x10, xzr, x15, eq
; GISEL-NEXT:    cmp x9, #5
; GISEL-NEXT:    ldr x15, [sp, #216] ; 8-byte Folded Reload
...
; GISEL-NEXT:    cmp x9, #7
; GISEL-NEXT:    orr x10, x14, x10
; GISEL-NEXT:    ldr x14, [sp, #288] ; 8-byte Folded Reload
; GISEL-NEXT:    csel x8, x10, x8, eq
; GISEL-NEXT:    cmp x11, #0
; GISEL-NEXT:    csel x10, xzr, x28, eq
; GISEL-NEXT:    cmp x9, #8
...
; GISEL-NEXT:    ldr x13, [sp, #120] ; 8-byte Folded Reload
; GISEL-NEXT:    csel x8, x10, x8, eq
; GISEL-NEXT:    cmp x11, #0
; GISEL-NEXT:    csel x10, xzr, x2, eq
; GISEL-NEXT:    cmp x9, #10
...
; GISEL-NEXT:    csel x8, x10, x8, eq
; GISEL-NEXT:    ldr x10, [sp, #152] ; 8-byte Folded Reload
; GISEL-NEXT:    cmp x11, #0
...
; GISEL-NEXT:    ldr x10, [sp, #112] ; 8-byte Folded Reload
; GISEL-NEXT:    stp x11, x10, [x13, #72]
; GISEL-NEXT:    csel x10, xzr, x25, eq
; GISEL-NEXT:    cmp x9, #14
; GISEL-NEXT:    orr x10, x26, x10
; GISEL-NEXT:    ldr x11, [sp, #104] ; 8-byte Folded Reload
; GISEL-NEXT:    csel x8, x10, x8, eq
; GISEL-NEXT:    cmp x9, #15
...
; GISEL-NEXT:    sub x15, x9, x10
; GISEL-NEXT:    lsr x9, x8, #6
; GISEL-NEXT:    str x6, [sp, #88] ; 8-byte Folded Spill
...
; GISEL-NEXT:    str x8, [sp, #264] ; 8-byte Folded Spill
; GISEL-NEXT:    csel x12, xzr, x16, eq
...
; GISEL-NEXT:    csel x11, x12, x11, eq
; GISEL-NEXT:    cmp x10, #0
; GISEL-NEXT:    str x13, [sp, #160] ; 8-byte Folded Spill
; GISEL-NEXT:    csel x12, xzr, x17, eq
; GISEL-NEXT:    cmp x9, #2
...
; GISEL-NEXT:    csel x12, xzr, x24, eq
; GISEL-NEXT:    cmp x9, #7
; GISEL-NEXT:    str x17, [sp, #120] ; 8-byte Folded Spill
; GISEL-NEXT:    orr x12, x2, x12
...
; GISEL-NEXT:    cmp x10, #0
; GISEL-NEXT:    str x8, [sp, #272] ; 8-byte Folded Spill
...
; GISEL-NEXT:    str x12, [sp, #24] ; 8-byte Folded Spill
; GISEL-NEXT:    cmp x9, #11
...
; GISEL-NEXT:    str x24, [sp, #56] ; 8-byte Folded Spill
...
; GISEL-NEXT:    str x8, [sp, #296] ; 8-byte Folded Spill
; GISEL-NEXT:    lsr x7, x12, x10
; GISEL-NEXT:    csel x11, x11, x17, eq
; GISEL-NEXT:    cmp x10, #0
; GISEL-NEXT:    str x12, [sp, #184] ; 8-byte Folded Spill
; GISEL-NEXT:    csel x15, xzr, x30, eq
; GISEL-NEXT:    cmp x9, #14
; GISEL-NEXT:    str x21, [sp, #64] ; 8-byte Folded Spill
...
; GISEL-NEXT:    cmp x9, #6
; GISEL-NEXT:    ldr x24, [sp, #104] ; 8-byte Folded Reload
; GISEL-NEXT:    orr x11, x2, x11
; GISEL-NEXT:    ldr x2, [sp, #112] ; 8-byte Folded Reload
; GISEL-NEXT:    csel x8, x11, x8, eq
; GISEL-NEXT:    cmp x10, #0
...
; GISEL-NEXT:    ldr x26, [sp, #96] ; 8-byte Folded Reload
; GISEL-NEXT:    csel x8, x11, x8, eq
; GISEL-NEXT:    cmp x10, #0
...
; GISEL-NEXT:    csel x8, xzr, x8, eq
; GISEL-NEXT:    cmp x6, #0
; GISEL-NEXT:    ldr x6, [sp, #24] ; 8-byte Folded Reload
; GISEL-NEXT:    csel x8, x11, x8, eq
; GISEL-NEXT:    cmp x10, #0
; GISEL-NEXT:    str x8, [sp, #192] ; 8-byte Folded Spill
; GISEL-NEXT:    csel x8, xzr, x17, eq
; GISEL-NEXT:    cmp x9, #0
; GISEL-NEXT:    orr x8, x3, x8
; GISEL-NEXT:    ldr x17, [sp, #56] ; 8-byte Folded Reload
; GISEL-NEXT:    csel x8, x8, xzr, eq
; GISEL-NEXT:    cmp x10, #0
; GISEL-NEXT:    csel x11, xzr, x13, eq
; GISEL-NEXT:    cmp x9, #1
...
; GISEL-NEXT:    csel x11, xzr, x2, eq
; GISEL-NEXT:    cmp x9, #6
; GISEL-NEXT:    ldr x2, [sp, #88] ; 8-byte Folded Reload
; GISEL-NEXT:    orr x11, x3, x11
; GISEL-NEXT:    csel x8, x11, x8, eq
; GISEL-NEXT:    cmp x10, #0
; GISEL-NEXT:    csel x11, xzr, x4, eq
; GISEL-NEXT:    ldr x4, [sp, #64] ; 8-byte Folded Reload
; GISEL-NEXT:    cmp x9, #7
...
; GISEL-NEXT:    cmp x9, #9
; GISEL-NEXT:    orr x11, x21, x11
; GISEL-NEXT:    ldr x21, [sp, #32] ; 8-byte Folded Reload
; GISEL-NEXT:    csel x8, x11, x8, eq
; GISEL-NEXT:    cmp x10, #0
; GISEL-NEXT:    csel x11, xzr, x24, eq
; GISEL-NEXT:    cmp x9, #10
...
; GISEL-NEXT:    csel x8, x11, x8, eq
; GISEL-NEXT:    cmp x10, #0
; GISEL-NEXT:    str x8, [sp, #328] ; 8-byte Folded Spill
...
; GISEL-NEXT:    csel x8, x11, x8, eq
; GISEL-NEXT:    cmp x10, #0
; GISEL-NEXT:    str x8, [sp, #320] ; 8-byte Folded Spill
...
; GISEL-NEXT:    csel x8, x11, x8, eq
; GISEL-NEXT:    cmp x9, #10
; GISEL-NEXT:    ldr x11, [sp, #216] ; 8-byte Folded Reload
; GISEL-NEXT:    csel x8, x21, x8, eq
; GISEL-NEXT:    cmp x9, #11
; GISEL-NEXT:    csel x8, xzr, x8, eq
; GISEL-NEXT:    cmp x9, #12
...
; GISEL-NEXT:    csel x11, x12, x11, eq
; GISEL-NEXT:    cmp x9, #7
; GISEL-NEXT:    ldr x12, [sp, #240] ; 8-byte Folded Reload
; GISEL-NEXT:    csel x11, x21, x11, eq
; GISEL-NEXT:    cmp x9, #8
; GISEL-NEXT:    csel x11, xzr, x11, eq
; GISEL-NEXT:    cmp x9, #9
...
; GISEL-NEXT:    csel x12, x14, x12, eq
; GISEL-NEXT:    cmp x9, #6
; GISEL-NEXT:    ldr x14, [sp, #248] ; 8-byte Folded Reload
...
; GISEL-NEXT:    csel x14, x2, x14, eq
; GISEL-NEXT:    cmp x9, #5
; GISEL-NEXT:    ldr x2, [sp, #256] ; 8-byte Folded Reload
...
; GISEL-NEXT:    csel x2, x4, x2, eq
; GISEL-NEXT:    cmp x9, #4
; GISEL-NEXT:    ldr x4, [sp, #272] ; 8-byte Folded Reload
...
; GISEL-NEXT:    csel x4, x6, x4, eq
; GISEL-NEXT:    cmp x9, #3
; GISEL-NEXT:    ldr x6, [sp, #280] ; 8-byte Folded Reload
...
; GISEL-NEXT:    cmp x9, #2
; GISEL-NEXT:    ldr x5, [sp, #288] ; 8-byte Folded Reload
...
; GISEL-NEXT:    csel x15, xzr, x15, eq
; GISEL-NEXT:    cmp x9, #4
; GISEL-NEXT:    ldr x17, [sp, #192] ; 8-byte Folded Reload
; GISEL-NEXT:    csel x15, xzr, x15, eq
; GISEL-NEXT:    cmp x9, #5
...
; GISEL-NEXT:    csel x15, xzr, x15, eq
; GISEL-NEXT:    cmp x9, #7
; GISEL-NEXT:    ldr x17, [sp, #264] ; 8-byte Folded Reload
; GISEL-NEXT:    csel x15, xzr, x15, eq
; GISEL-NEXT:    cmp x9, #8
...
; GISEL-NEXT:    csel x8, xzr, x8, eq
; GISEL-NEXT:    cmp x9, #13
; GISEL-NEXT:    ldr x17, [sp, #320] ; 8-byte Folded Reload
; GISEL-NEXT:    csel x8, xzr, x8, eq
; GISEL-NEXT:    cmp x9, #14
; GISEL-NEXT:    csel x8, xzr, x8, eq
; GISEL-NEXT:    cmp x9, #15
; GISEL-NEXT:    ldr x9, [sp, #184] ; 8-byte Folded Reload
; GISEL-NEXT:    csel x8, xzr, x8, eq
; GISEL-NEXT:    cmp x26, #0
...
; GISEL-NEXT:    str x17, [sp, #240] ; 8-byte Folded Spill
; GISEL-NEXT:    csel x8, xzr, x8, eq
...
; GISEL-NEXT:    str x0, [sp, #272] ; 8-byte Folded Spill
; GISEL-NEXT:    cmp x10, #1
; GISEL-NEXT:    orr x9, x21, x9
; GISEL-NEXT:    str x16, [sp, #152] ; 8-byte Folded Spill
...
; GISEL-NEXT:    csel x9, xzr, x13, eq
; GISEL-NEXT:    cmp x10, #2
; GISEL-NEXT:    str x17, [sp, #112] ; 8-byte Folded Spill
; GISEL-NEXT:    lsl x4, x14, x15
; GISEL-NEXT:    orr x9, x17, x9
; GISEL-NEXT:    str x16, [sp, #344] ; 8-byte Folded Spill
; GISEL-NEXT:    csel x8, x9, x8, eq
; GISEL-NEXT:    cmp x12, #0
...
; GISEL-NEXT:    csel x8, x9, x8, eq
; GISEL-NEXT:    cmp x12, #0
; GISEL-NEXT:    str x13, [sp, #336] ; 8-byte Folded Spill
...
; GISEL-NEXT:    str x5, [sp, #208] ; 8-byte Folded Spill
...
; GISEL-NEXT:    str x9, [sp, #88] ; 8-byte Folded Spill
...
; GISEL-NEXT:    str x9, [sp, #80] ; 8-byte Folded Spill
; GISEL-NEXT:    csel x16, x2, x16, eq
; GISEL-NEXT:    cmp x12, #0
...
; GISEL-NEXT:    csel x16, x2, x16, eq
; GISEL-NEXT:    cmp x12, #0
; GISEL-NEXT:    str x28, [sp, #264] ; 8-byte Folded Spill
; GISEL-NEXT:    csel x30, xzr, x20, eq
; GISEL-NEXT:    cmp x10, #14
; GISEL-NEXT:    str x8, [sp, #288] ; 8-byte Folded Spill
; GISEL-NEXT:    orr x30, x27, x30
; GISEL-NEXT:    str x19, [sp, #224] ; 8-byte Folded Spill
; GISEL-NEXT:    ldr x15, [sp, #360] ; 8-byte Folded Reload
...
; GISEL-NEXT:    ldr x5, [sp, #72] ; 8-byte Folded Reload
; GISEL-NEXT:    orr x28, x23, x28
; GISEL-NEXT:    ldp x13, x26, [sp, #104] ; 16-byte Folded Reload
; GISEL-NEXT:    csel x28, x28, x30, eq
; GISEL-NEXT:    ldr x30, [sp, #136] ; 8-byte Folded Reload
; GISEL-NEXT:    str x6, [sp, #232] ; 8-byte Folded Spill
; GISEL-NEXT:    ldp x9, x16, [sp, #336] ; 16-byte Folded Reload
; GISEL-NEXT:    str x14, [sp, #56] ; 8-byte Folded Spill
; GISEL-NEXT:    cmp x30, #0
; GISEL-NEXT:    ldp x2, x6, [sp, #80] ; 16-byte Folded Reload
; GISEL-NEXT:    csel x8, x24, x28, eq
; GISEL-NEXT:    cmp x12, #0
; GISEL-NEXT:    ldr x24, [sp, #96] ; 8-byte Folded Reload
; GISEL-NEXT:    str x8, [sp, #144] ; 8-byte Folded Spill
; GISEL-NEXT:    ldp x19, x8, [sp, #120] ; 16-byte Folded Reload
; GISEL-NEXT:    str x20, [sp, #48] ; 8-byte Folded Spill
; GISEL-NEXT:    str x23, [sp, #64] ; 8-byte Folded Spill
; GISEL-NEXT:    csel x28, xzr, x8, eq
; GISEL-NEXT:    cmp x10, #0
; GISEL-NEXT:    ldr x8, [sp, #296] ; 8-byte Folded Reload
; GISEL-NEXT:    orr x21, x21, x28
; GISEL-NEXT:    str x17, [sp, #280] ; 8-byte Folded Spill
; GISEL-NEXT:    csel x21, x21, x11, eq
; GISEL-NEXT:    cmp x12, #0
; GISEL-NEXT:    str x4, [sp, #40] ; 8-byte Folded Spill
; GISEL-NEXT:    csel x28, xzr, x19, eq
; GISEL-NEXT:    cmp x10, #1
; GISEL-NEXT:    stp x7, x0, [sp, #24] ; 16-byte Folded Spill
; GISEL-NEXT:    orr x28, x26, x28
; GISEL-NEXT:    str x25, [sp, #16] ; 8-byte Folded Spill
...
; GISEL-NEXT:    ldr x15, [sp, #352] ; 8-byte Folded Reload
; GISEL-NEXT:    cmp x10, #8
...
; GISEL-NEXT:    ldr x14, [sp, #312] ; 8-byte Folded Reload
; GISEL-NEXT:    csel x21, x28, x21, eq
; GISEL-NEXT:    cmp x12, #0
...
; GISEL-NEXT:    cmp x12, #0
; GISEL-NEXT:    csel x28, xzr, x8, eq
; GISEL-NEXT:    ldr x8, [sp, #304] ; 8-byte Folded Reload
; GISEL-NEXT:    cmp x10, #12
...
; GISEL-NEXT:    cmp x10, #13
; GISEL-NEXT:    ldr x20, [sp, #288] ; 8-byte Folded Reload
...
; GISEL-NEXT:    cmp x10, #14
; GISEL-NEXT:    orr x28, x23, x28
; GISEL-NEXT:    ldr x23, [sp, #240] ; 8-byte Folded Reload
; GISEL-NEXT:    csel x21, x28, x21, eq
; GISEL-NEXT:    cmp x10, #15
...
; GISEL-NEXT:    str x21, [sp, #240] ; 8-byte Folded Spill
...
; GISEL-NEXT:    csel x21, x28, x21, eq
; GISEL-NEXT:    cmp x12, #0
; GISEL-NEXT:    str x16, [sp, #8] ; 8-byte Folded Spill
; GISEL-NEXT:    csel x28, xzr, x13, eq
; GISEL-NEXT:    cmp x10, #2
...
; GISEL-NEXT:    csel x28, xzr, x14, eq
; GISEL-NEXT:    cmp x10, #10
; GISEL-NEXT:    ldr x14, [sp, #40] ; 8-byte Folded Reload
; GISEL-NEXT:    orr x28, x2, x28
; GISEL-NEXT:    csel x21, x28, x21, eq
; GISEL-NEXT:    cmp x12, #0
...
; GISEL-NEXT:    cmp x12, #0
; GISEL-NEXT:    csel x28, xzr, x20, eq
; GISEL-NEXT:    ldr x20, [sp, #64] ; 8-byte Folded Reload
; GISEL-NEXT:    cmp x10, #13
...
; GISEL-NEXT:    str x21, [sp, #216] ; 8-byte Folded Spill
; GISEL-NEXT:    csel x21, xzr, x14, eq
; GISEL-NEXT:    ldr x14, [sp, #344] ; 8-byte Folded Reload
; GISEL-NEXT:    cmp x10, #0
...
; GISEL-NEXT:    cmp x10, #1
; GISEL-NEXT:    ldr x23, [sp, #336] ; 8-byte Folded Reload
; GISEL-NEXT:    orr x28, x8, x28
; GISEL-NEXT:    csel x21, x28, x21, eq
; GISEL-NEXT:    cmp x12, #0
; GISEL-NEXT:    csel x28, xzr, x23, eq
...
; GISEL-NEXT:    csel x28, xzr, x3, eq
; GISEL-NEXT:    cmp x10, #4
; GISEL-NEXT:    ldr x3, [sp, #32] ; 8-byte Folded Reload
...
; GISEL-NEXT:    csel x28, xzr, x9, eq
; GISEL-NEXT:    cmp x10, #6
; GISEL-NEXT:    ldr x9, [sp, #328] ; 8-byte Folded Reload
; GISEL-NEXT:    orr x28, x17, x28
; GISEL-NEXT:    ldr x17, [sp, #312] ; 8-byte Folded Reload
; GISEL-NEXT:    csel x21, x28, x21, eq
; GISEL-NEXT:    cmp x12, #0
; GISEL-NEXT:    csel x28, xzr, x9, eq
; GISEL-NEXT:    cmp x10, #7
...
; GISEL-NEXT:    csel x28, xzr, x19, eq
; GISEL-NEXT:    cmp x10, #11
; GISEL-NEXT:    ldr x19, [sp, #288] ; 8-byte Folded Reload
; GISEL-NEXT:    orr x28, x27, x28
; GISEL-NEXT:    csel x21, x28, x21, eq
; GISEL-NEXT:    cmp x12, #0
; GISEL-NEXT:    csel x28, xzr, x19, eq
...
; GISEL-NEXT:    csel x21, x28, x21, eq
; GISEL-NEXT:    cmp x10, #13
; GISEL-NEXT:    ldr x28, [sp, #152] ; 8-byte Folded Reload
; GISEL-NEXT:    csel x21, x11, x21, eq
; GISEL-NEXT:    cmp x10, #14
; GISEL-NEXT:    csel x21, x11, x21, eq
; GISEL-NEXT:    cmp x10, #15
...
; GISEL-NEXT:    csel x21, x28, x21, eq
; GISEL-NEXT:    cmp x12, #0
; GISEL-NEXT:    str x21, [sp, #344] ; 8-byte Folded Spill
; GISEL-NEXT:    csel x21, xzr, x7, eq
; GISEL-NEXT:    cmp x10, #0
; GISEL-NEXT:    orr x21, x8, x21
; GISEL-NEXT:    ldr x7, [sp, #360] ; 8-byte Folded Reload
; GISEL-NEXT:    mov x8, x23
; GISEL-NEXT:    csel x21, x21, x11, eq
; GISEL-NEXT:    cmp x12, #0
; GISEL-NEXT:    csel x28, xzr, x23, eq
; GISEL-NEXT:    cmp x10, #1
; GISEL-NEXT:    ldr x23, [sp, #320] ; 8-byte Folded Reload
; GISEL-NEXT:    orr x28, x16, x28
; GISEL-NEXT:    ldr x16, [sp, #16] ; 8-byte Folded Reload
; GISEL-NEXT:    csel x21, x28, x21, eq
; GISEL-NEXT:    cmp x12, #0
; GISEL-NEXT:    csel x28, xzr, x0, eq
; GISEL-NEXT:    cmp x10, #2
...
; GISEL-NEXT:    csel x21, x28, x21, eq
; GISEL-NEXT:    cmp x10, #12
; GISEL-NEXT:    ldr x28, [sp, #160] ; 8-byte Folded Reload
; GISEL-NEXT:    csel x21, x11, x21, eq
; GISEL-NEXT:    cmp x10, #13
; GISEL-NEXT:    csel x21, x11, x21, eq
; GISEL-NEXT:    cmp x10, #14
...
; GISEL-NEXT:    cmp x10, #0
; GISEL-NEXT:    orr x21, x8, x21
; GISEL-NEXT:    ldr x8, [sp, #280] ; 8-byte Folded Reload
; GISEL-NEXT:    csel x21, x21, x11, eq
; GISEL-NEXT:    cmp x12, #0
; GISEL-NEXT:    csel x22, xzr, x22, eq
; GISEL-NEXT:    cmp x10, #1
...
; GISEL-NEXT:    csel x21, x22, x21, eq
; GISEL-NEXT:    cmp x10, #11
; GISEL-NEXT:    ldr x22, [sp, #168] ; 8-byte Folded Reload
; GISEL-NEXT:    csel x21, x11, x21, eq
; GISEL-NEXT:    cmp x10, #12
; GISEL-NEXT:    csel x21, x11, x21, eq
; GISEL-NEXT:    cmp x10, #13
...
; GISEL-NEXT:    csel x4, x7, x4, eq
; GISEL-NEXT:    cmp x10, #10
; GISEL-NEXT:    ldr x7, [sp, #176] ; 8-byte Folded Reload
...
; GISEL-NEXT:    csel x3, xzr, x16, eq
; GISEL-NEXT:    cmp x10, #0
; GISEL-NEXT:    ldr x16, [sp, #144] ; 8-byte Folded Reload
...
; GISEL-NEXT:    csel x0, x3, x0, eq
; GISEL-NEXT:    cmp x10, #9
; GISEL-NEXT:    ldr x3, [sp, #184] ; 8-byte Folded Reload
...
; GISEL-NEXT:    csel x8, x9, x8, eq
; GISEL-NEXT:    cmp x10, #7
; GISEL-NEXT:    ldr x9, [sp, #200] ; 8-byte Folded Reload
; GISEL-NEXT:    csel x8, x11, x8, eq
; GISEL-NEXT:    cmp x10, #8
; GISEL-NEXT:    csel x8, x11, x8, eq
; GISEL-NEXT:    cmp x10, #9
...
; GISEL-NEXT:    csel x9, xzr, x15, eq
; GISEL-NEXT:    cmp x10, #0
; GISEL-NEXT:    ldr x15, [sp, #272] ; 8-byte Folded Reload
; GISEL-NEXT:    orr x9, x25, x9
...
; GISEL-NEXT:    csel x17, xzr, x5, eq
; GISEL-NEXT:    cmp x10, #3
; GISEL-NEXT:    ldr x16, [sp, #344] ; 8-byte Folded Reload
; GISEL-NEXT:    orr x17, x6, x17
...
; GISEL-NEXT:    csel x9, x17, x9, eq
; GISEL-NEXT:    cmp x10, #6
; GISEL-NEXT:    ldr x17, [sp, #208] ; 8-byte Folded Reload
...
; GISEL-NEXT:    orr x17, x24, x17
; GISEL-NEXT:    ldr x9, [sp, #264] ; 8-byte Folded Reload
...
; GISEL-NEXT:    csel x17, x3, x17, eq
; GISEL-NEXT:    cmp x10, #5
; GISEL-NEXT:    ldr x3, [sp, #224] ; 8-byte Folded Reload
...
; GISEL-NEXT:    csel x3, x7, x3, eq
; GISEL-NEXT:    cmp x10, #4
; GISEL-NEXT:    ldr x7, [sp, #232] ; 8-byte Folded Reload
...
; GISEL-NEXT:    csel x5, x6, x5, eq
; GISEL-NEXT:    cmp x10, #3
; GISEL-NEXT:    ldr x6, [sp, #248] ; 8-byte Folded Reload
