...
; SDISEL:       // %bb.0:
; SDISEL-NEXT:    cmp w0, w2
; SDISEL-NEXT:    ccmp w1, #31, #0, lt
; SDISEL-NEXT:    csel w0, w1, w0, le
; SDISEL-NEXT:    ret
;
...
; SDISEL:       // %bb.0:
; SDISEL-NEXT:    cmp w0, w2
; SDISEL-NEXT:    ccmn w1, #31, #0, lo
; SDISEL-NEXT:    csel w0, w1, w0, hs
; SDISEL-NEXT:    ret
;
...
; SDISEL:       // %bb.0:
; SDISEL-NEXT:    cmp w0, w2
; SDISEL-NEXT:    ccmp w1, #31, #2, lo
; SDISEL-NEXT:    csel w0, w1, w0, ls
; SDISEL-NEXT:    ret
;
